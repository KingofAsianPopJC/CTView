...
void ImageInteractor::MoveSliceForward()
{
	if (_Slice < _MaxSlice) {
		_Slice += 1;
...
void ImageInteractor::MoveSliceBackward()
{
	if (_Slice > _MinSlice) {
		_Slice -= 1;
...
void ImageInteractor::OnKeyDown()
{
...
void ImageInteractor::OnMouseWheelForward()
{
...
void ImageInteractor::OnMouseWheelBackward()
{
